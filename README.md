...
Проект ориентирован на демонстрацию fullstack-подхода: изоляция данных по организациям, RBAC на backend, refresh-token rotation, разделение server/client state и продуманная доменная модель.
...
* работу с задачами, проектами и Kanban-представлением
